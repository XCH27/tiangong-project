...
真实 Goose / Custom ACP 只能做 opt-in smoke，不进入默认 CI。Claude/Codex/Grok/Hermes/OpenCode/Antigravity/Qwen/Pi/Cursor Agent/OpenClaw 等未接 native/subscription adapter 前只能检测和展示，不能承诺已可发送。
