...
| DWF-4 DesignAction 契约 | UI 和 AI 都通过同一套 action 选择、注释、编辑 artifact，写入 timeline/permission/rollback | 契约、DesignEngine、`design_*` 事件、annotate applier 已集成；样式/Artifact/file applier 继续 |
