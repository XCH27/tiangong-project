...
| CTX-4 外部审查报告 | 原始输出、findings、bundle hash、平台、Fleet token 与外部成本分开归档；提供 LOCAL_ONLY RPC | `shared/protocol/external-review.ts`、`external-review-report.ts`、`externalReview:*` |
