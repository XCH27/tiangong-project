...
export const KEYS = {
  ...
  workspaceContextSidebarVisibleRestored: 'workspace-context-sidebar-visible-restored',
  workspaceContextSidebarWidth: 'workspace-context-sidebar-width',
  bottomTerminalVisible: 'bottom-terminal-visible',
  bottomTerminalHeight: 'bottom-terminal-height',
  workspaceToolDockActive: 'workspace-tool-dock-active',
  workspaceToolDockRatios: 'workspace-tool-dock-ratios',
