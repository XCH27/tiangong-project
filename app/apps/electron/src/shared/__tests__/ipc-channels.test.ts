...
const EXPECTED_CHANNELS: string[] = [
  ...
  'chatgpt:logout',
  'chatgpt:startOAuth',
  'cliRuntimes:addCustom',
  'cliRuntimes:changed',
  'cliRuntimes:delete',
  'cliRuntimes:get',
  'cliRuntimes:list',
  'cliRuntimes:setEnabled',
  'cliRuntimes:test',
  'cliRuntimes:updateCustom',
  'copilot:cancelOAuth',
  'copilot:deviceCode',
  ...
  'input:setSpellCheck',
  'internalActions:invoke',
  'internalActions:list',
  'labels:changed',
  'labels:create',
  'labels:delete',
  'labels:list',
  'logo:getUrl',
  'managerDecision:getSettings',
  'managerDecision:updateSettings',
  'memory:add',
  'memory:delete',
  'memory:get',
  'memory:list',
