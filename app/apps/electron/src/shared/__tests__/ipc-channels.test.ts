...
const EXPECTED_CHANNELS: string[] = [
  ...
  "agentLifecycle:get",
  "agentLifecycle:list",
  "agentLifecycle:markActive",
  "agentLifecycle:stop",
  "agentLifecycle:update",
  "agents:get",
  "agents:list",
  ...
  "cli-runtime:test",
  "contextAdapter:compressRtk",
  "contextAdapter:queryCodegraph",
  "contextCenter:getOverview",
  "copilot:cancelOAuth",
  "copilot:deviceCode",
  ...
  "design:commitPatch",
  "design:getSelection",
  "design:proposeAction",
  "design:rollbackPatch",
  "design:setSelection",
  "dialog:openFolder",
  "drafts:delete",
  "drafts:get",
  ...
  "systemTools:detectAll",
  "systemTools:detectCategory",
  "systemTools:detectTool",
  "systemTools:diagnoseProject",
  "systemTools:getBestTool",
  "systemTools:getProjectProfile",
  "systemTools:listTools",
  "tasks:getOutput",
  "theme:appChanged",
