 ...
 * electron-updater library. Updates are served from the generic provider URL in
 * electron-builder.yml (override at pack time via FLEET_ELECTRON_UPDATE_URL / electron:dist:*:fleet).
 *
 * Platform behavior:
