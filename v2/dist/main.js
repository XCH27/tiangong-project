import { loadUserV2Config, resolveV2Config } from "./config/V2Config.js";
...
async function autoDetectLiveBackend(config) {
    if (config.live || process.env.OE_LIVE != null || loadUserV2Config().live != null)
        return config;
    try {
