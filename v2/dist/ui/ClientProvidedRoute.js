...
export function clientProvidedDepth(_requestedDepth) {
    return "text_only";
}
export function buildClientProvidedMetadata(source, providedPath) {
...
export function markClientProvidedPlan(plan) {
