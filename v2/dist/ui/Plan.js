import { getTheme, ansiFg, ansiReset } from "../theme/theme.js";
...
const TIME_LABEL = { fast: "快", moderate: "中等", slow: "较慢" };
export function renderPlanState({ theme, meta, plan, width, }) {
    ...
    lines.push(`  ${ansiFg(t.accent)}┃ ${ansiFg(t.text_l3)}${PLATFORM_LABEL[meta.platform] || String(meta.platform)} · ${dur} · ${meta.has_official_subtitles ? `有官方字幕(${meta.subtitle_languages.join(",")})` : "无官方字幕"}${ansiReset}`);
