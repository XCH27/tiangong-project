 ...
 */
export const probeVideoTool: AgentTool<any, any> = {
  name: "probe_video",
 ...
 */
export const analyzeVideoTool: AgentTool<any, any> = {
  name: "analyze_video",
...
function taskRefLike(value: unknown): Record<string, unknown> {
  return value && typeof value === "object" ? value as Record<string, unknown> : {};
}

function taskRefString(value: unknown): string {
 ...
 */
export const searchDatabaseTool: AgentTool<any, any> = {
